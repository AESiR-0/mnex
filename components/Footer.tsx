    ...
    <footer className="w-full bg-[#eaeaea]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        ...
        <div className="flex flex-col md:flex-row lg:justify-between gap-8 md:gap-0">
          ...
          <div className="flex flex-col w-full md:w-1/2 font-medium justify-between gap-6 md:gap-0">
            {/* Logo */}
            <div className="min-h-32 sm:min-h-40 md:min-h-48 w-full">
              ...
              <p className="text-sm lg:text-base xl:text-lg text-[#595959] pb-2 sm:pb-3">
                Mnex Singapore <br />
                8 Temasek Blvd, Suntec Tower 3 <br />
                #44-02, Singapore 038 988
              </p>
              <h5 className="text-sm lg:text-base xl:text-lg text-[#1789FF] pb-1 sm:pb-2">
                Our Facilities
              </h5>
              <p className="text-sm lg:text-base xl:text-lg text-[#595959] pb-2 sm:pb-3">
                Mnex China <br />
              ...
              <p className="text-sm lg:text-base xl:text-lg text-[#595959] pb-3 sm:pb-5">
                Mnex Malaysia <br />
          ...
          <div className="flex flex-col gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="pt-3 sm:pt-4 lg:pt-6">
              <div className="flex flex-col md:flex-row md:items-center gap-2 sm:gap-3 lg:gap-4 text-xs sm:text-sm text-[#595959]">
