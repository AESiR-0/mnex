    ...
    <main className="bg-[#F5F5F5] min-h-screen flex flex-col">
      ...
      <section className="w-full min-h-[75vh] flex items-center">
        <div className="max-w-7xl mx-auto w-full flex justify-around gap-40  items-center px-4">
          <div className="w-1/2 flex flex-col gap-4">
            <h2 className="text-lg font-semibold text-[#595959] mb-2 uppercase tracking-widest">
              Our Approach
            </h2>
            <div className="text-4xl font-semibold text-[#595959] mb-2">
              {approachContent[activeApproach]?.title}
            </div>
            <div className="text-[#009B80] text-xl mb-4">
              {approachContent[activeApproach]?.desc}
            </div>
          </div>
      ...
      <section className="relative w-full  h-[80vh] flex items-end">
        ...
        <div className="absolute flex flex-col gap-4 text-xl justify-center  h-[80vh] pl-30 bottom-0  max-w-xl z-10 bg-gradient-to-r from-black/80 to-transparent rounded-tr-2xl rounded-br-2xl">
          <div className="text-lg text-[#A8D3FF] uppercase mb-2">
            Case Study
          </div>
          <div className="text-4xl font-semibold mb-2 text-white">
            Speed Without Compromise
          </div>
          <div className="text-[#A8D3FF] mb-2">
            Delivering results at the intersection of speed and precision.
          </div>
          <div className="text-white mb-4">
            Our advanced manufacturing process enables rapid prototyping and
            delivery without sacrificing quality or accuracy.
          </div>
          <button className="mt-4 px-6 py-2 border border-white rounded-full text-white bg-transparent hover:bg-white/10 transition">
            Know more
          </button>
        </div>
      </section>
      ...
      <section className="w-full  justify-center  flex items-center">
        <div className="max-w-7xl  w-full flex justify-center  gap-0 ">
          <div className=" text-[#1789FF] w-full   flex flex-col justify-center p-8 md:rounded-l-2xl min-h-[300px]">
            <h2 className="text-xs font-semibold text-[#595959]  uppercase tracking-widest mb-2">
              Solutions
            </h2>
      ...
      <section className="w-full min-h-screen flex items-center bg-white">
        <div className="max-w-7xl mx-auto w-full">
          <h2 className="text-2xl md:text-3xl font-semibold text-center mb-8 text-[#595959]">
          ...
          <div className="relative w-full h-[70vh] my-20 rounded-xl overflow-hidden">
            ...
            <div className="absolute left-0 top-0 h-full flex flex-col justify-center p-10 z-10">
              <div className="text-white text-2xl md:text-3xl font-semibold mb-2">
                {tabData[activeTab].title}
              </div>
              <div className="text-[#A8D3FF] mb-4 max-w-md">
                {tabData[activeTab].desc}
              </div>
              <div className="flex gap-4 mt-2">
                <div className="rounded-full bg-white/10 border border-white px-6 py-3 text-white text-center text-lg font-semibold whitespace-pre">
                  30+ patents
                </div>
                <div className="rounded-full bg-white/10 border border-white px-6 py-3 text-white text-center text-lg font-semibold">
                  CNC
                </div>
                <div className="rounded-full bg-white/10 border border-white px-6 py-3 text-white text-center text-lg font-semibold">
                  EDM
      ...
      <section className="w-full min-h-[75vh] flex items-center bg-[#009B80] text-white">
        <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center justify-center gap-8">
          <div className="flex-1 max-w-xl">
            ...
            <button className="mt-2 px-6 py-2 border border-white rounded-full text-white bg-transparent hover:bg-white/10 transition">
              Learn More
            </button>
          </div>
          <div className="flex-1 grid grid-cols-3 grid-rows-2 gap-4">
            {[
              ...
              <div
                key={i}
                className="rounded-2xl bg-white/10 border border-white flex items-center justify-center text-center text-lg font-semibold min-h-[80px] whitespace-pre-line"
              >
                {item}
              </div>
            ))}
